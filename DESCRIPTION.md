...
- Prebuilt kernel-specific `.deb` packages
- Signed APT repository for Ubuntu 24.04 (Noble), amd64
- GitHub Actions builds from the exact XanMod source tag
- GitHub Releases for downloadable artifacts
